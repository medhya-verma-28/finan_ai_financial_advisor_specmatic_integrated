...
DATA_PATH = "indian_finance_ml_dataset_balanced_final.csv"
...
def analyze():
    ...
    try:
        ...
        monthly_income = extracted_features[0]
        cost_of_living = extracted_features[1]
        other_investments = extracted_features[2]
        consumerist_expenditure = extracted_features[3]
        crisis_shock_expenditure = extracted_features[4]
        total_monthly_expenditure = extracted_features[5]
        debt_status = extracted_features[6]
        ...
        suggested_cost_of_living = suggested_cost_of_living_percentage[0] * monthly_income
        suggested_other_investments = suggested_other_investments_percentage[0] * monthly_income
        suggested_consumerist_expenditure = suggested_consumerist_expenditure_percentage[0] * monthly_income
        suggested_crisis_shocks = suggested_crisis_shocks_percentage[0] * monthly_income
...
Cost of Living Expenditure (INR): {cost_of_living}
Other Important Investments (INR): {other_investments}
Consumerist Expenditure (INR): {consumerist_expenditure}
Crisis Shock Expenditure (INR): {crisis_shock_expenditure}
Total Monthly Expenditure (INR): {total_monthly_expenditure}
...
"""
        ...
        return jsonify({
            ...
            'extracted': {
                ...
                'investments': other_investments,
                'consumerist': consumerist_expenditure,
                'crisis_shock': crisis_shock_expenditure,
            ...
            'budgets': {
                'cost_of_living': round(suggested_cost_of_living, 2),
                'investments': round(suggested_other_investments, 2),
                'consumerist': round(suggested_consumerist_expenditure, 2),
                'crisis_shock': round(suggested_crisis_shocks, 2),
            }
        })
